    ...
    return (
      <View>
        <Text>
          ...
          applicable.  These terms and conditions were created using Termly.
          Option 1: The Site is intended for users who are at least 18 years
          old. Persons under the age of 18 are not permitted to register for the
          Site. Option 2: [The Site is intended for users who are at least 13
          years of age.] All users who are minors in the jurisdiction in which
          they reside (generally under the age of 18) must have the permission
          of, and be directly supervised by, their parent or guardian to use the
          ...
          under the age of 13;] (5) not a minor in the jurisdiction in which you
          ...
          will not use the Site for any illegal or unauthorized purpose; (8)
          ...
          ACTIVITIES You may not access or use the Site for any purpose other
          than that for which we make the Site available. The Site may not be
          ...
          agent or purchasing agent to make purchases on the Site. use the Site
          to advertise or offer to sell goods and services. circumvent, disable,
          ...
          linking to the Site. trick, defraud, or mislead us and other users,
          especially in any attempt to learn sensitive account information such
          as user passwords; make improper use of our support services or submit
          false reports of abuse or misconduct. engage in any automated use of
          ...
          extraction tools. interfere with, disrupt, or create an undue burden
          on the Site or the networks or services connected to the Site. attempt
          to impersonate another user or person or use the username of another
          user. sell or otherwise transfer your profile. use any information
          obtained from the Site in order to harass, abuse, or harm another
          person. use the Site as part of any effort to compete with us or
          ...
          making up a part of the Site. attempt to bypass any measures of the
          ...
          you. delete the copyright or other proprietary rights notice from any
          Content. copy or adapt the Site’s software, including but not limited
          to Flash, PHP, HTML, JavaScript, or other code. upload or transmit (or
          ...
          functions, operation, or maintenance of the Site. upload or transmit
          ...
          or “pcms”). except as may be the result of standard search engine or
          ...
          Site. use the Site in a manner inconsistent with any applicable laws
          or regulations. [other] USER GENERATED CONTRIBUTIONS The Site may
          ...
          of the Site to use your Contributions in any manner contemplated by
          the Site and these Terms and Conditions. you have the written consent,
          ...
          Terms and Conditions. your Contributions are not false, inaccurate, or
          ...
          the Site to leave reviews or ratings. When posting a review, you must
          ...
          respect to the mobile application; (3) in the event of any failure of
          the mobile application to conform to any applicable warranty, you may
          ...
          wireless data service agreement when using the mobile application; 6)
          ...
          you as a third-party beneficiary thereof. SOCIAL MEDIA As part of the
          ...
          and Conditions; (2) take appropriate legal action against anyone who,
          in our sole discretion, violates the law or these Terms and
          ...
          are in any way burdensome to our systems; (5) otherwise manage the
          ...
          [CLICK HERE]/posted on the Site]. By using the Site, you agree to be
          bound by our Privacy Policy, which is incorporated into these Terms
          and Conditions. Please be advised the Site is hosted in the United
          ...
          infringed upon. Counter Notification If you believe your own
          copyrighted material has been removed from the Site as a result of a
          ...
          or misidentification of the material to be removed or disabled; (6)
          your physical or electronic signature. If you send us a valid, written
          ...
          that if you materially misrepresent that the disabled or removed
          content was removed by mistake or misidentification, you may be liable
          for damages, including costs and attorney's fees. Filing a false
          Counter Notification constitutes perjury. Designated Copyright Agent
          [Name] Attn: Copyright Agent [Address] [City, State Zip] [email]
          ...
          a Notification. Thus, if you are not sure that material located on or
          linked to by the Site infringes your copyright, you should consider
          first contacting an attorney.] TERM AND TERMINATION These Terms and
          ...
          pursuing civil, criminal, and injunctive redress. MODIFICATIONS AND
          ...
          or releases in connection therewith. GOVERNING LAW These Terms and
          Conditions and your use of the Site are governed by and construed in
          accordance with the laws of the State of [name of state] applicable to
          ...
          of law principles. DISPUTE RESOLUTION Option 1: Any legal action of
          whatever nature brought by either you or us (collectively, the
          “Parties” and individually, a “Party”) shall be commenced or
          prosecuted in the state and federal courts located in [name of county]
          County, [name of state], and the Parties hereby consent to, and waive
          ...
          years after the cause of action arose. Option 2: Informal Negotiations
          ...
          data. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES Visiting
          ...
          us at: [Corporate Name] [Corporate Address] [Corporate Phone Number]
          [Corporate Fax Number] [Email Address]
        </Text>
      </View>
    );
}
