export const Charities = [
  { title: "Abilities" },
  { title: "ABILITY Awareness" },
  { title: "Ability Foundation" },
  { title: "AbleThrive" },
  { title: "ABRAR (Sudan)" },
  { title: "Accessibility Organization for Afghanistan Disabled (AOAD)" },
  ...
  //   "Associação Nacional de Membros do Ministério Público de Defesa Dos Direitos dos Idosos e",
  //   "Pessoas com Deficiência (AMPID) (National Association of Members of the Public Prosecutor’s ",
  //   "Defense of the Rights of the Elderly and Persons with Disabilities)",
